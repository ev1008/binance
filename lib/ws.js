...
class BinanceWS {
    constructor(beautify = true, streamType = 'dstream') {
        this._baseUrl = `wss://${streamType}.binance.com/ws/`;
        this._combinedBaseUrl = `wss://${streamType}.binance.com/stream?streams=`;
        this._sockets = {};
